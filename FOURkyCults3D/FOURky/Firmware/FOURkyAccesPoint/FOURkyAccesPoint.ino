...
int a0, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10, a11, a12, a0r, a1r, a2r, a3r, a4r, a5r, a6r, a7r, a8r, a9r, a10r, a11r, a12r; 
        ...
        <div class="item-bt3">
            <table>    
                <tr>
                  ...
                  <td><button id ="plus" class="button" ontouchstart="toggleCheckbox('PLUS');" ontouchend="toggleCheckbox('plus');">+</button></td>
                ...
                <tr>
                  ...
                  <td><button id="minus" class="button" ontouchstart="toggleCheckbox('MINUS');" ontouchend="toggleCheckbox('minus');">-</button></td>
                ...
                <tr>
                  ...
                  <td><button id ="zero" class="button" ontouchstart="toggleCheckbox('ZERO');" ontouchend="toggleCheckbox('zero');">0</button></td>
                  <td><button id="full" class="button" ontouchstart="toggleCheckbox('FULL');" ontouchend="toggleCheckbox('full');" >180</button></td>
                </tr>
            </table>
        </div>
...
//###################################################
//ZERO ##############################################
if(!strcmp(variable, "ZERO")) {
    angle = 0;
}
//###################################################
//FULL ##############################################
if(!strcmp(variable, "FULL")) {
    angle = 180;
}
//###################################################
...
if(a12r<=a12-eps){
  setServo(12,180-a12r+comp12); 
  a12r = a12r+t;
}
else if(a12r>=a12+eps){
  setServo(12,180-a12r+comp12); 
  a12r = a12r-t;
}
else{
